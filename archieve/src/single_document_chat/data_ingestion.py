...
class SingleDocIngestor:
    ...
    def __init__(self, data_dir:str ="data/single_document_chat", faiss_dir:str ="faiss_index"):
        ...
        try:
            ...
            self.log.info("SingleDocIngestor successfully initialized",data_path=str(self.data_dir), faiss_path=str(faiss_dir))
    ...
    def ingest_files(self,uploaded_files):
        try:
            ...
            for uploaded_file in uploaded_files:
                unique_filename = f"{datetime.now(timezone.utc).strftime('%Y%m%d_%H%M%S')}_{uuid.uuid4().hex[:8]}.pdf"
