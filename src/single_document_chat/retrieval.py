...
class ConversationalRAG:
    def __init__(self, session_id:str, retriever) -> None :
        try:
            ...
            self.log.info("Created history-aware retriever", session_is=session_id)
    ...
    def _get_session_history(self, session_id:str) -> BaseChatMessageHistory:
        try:
            ...
            self.log.error("Failed to access the session history",error=str(e), session_id=self.session_id)
